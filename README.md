...
* [AI Example Lecture Video](https://lessipe.com/course/31) - Various example lectures related to AI such as face recognition, data analysis, object tracking and etc.
